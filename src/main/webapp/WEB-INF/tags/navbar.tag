...
<%--                </sec:authorize>--%>
                <li class="nav-item">
                    <a class="nav-link ${current eq 'campaignList' ? 'active' : '' }" href="/campaign/campaignList" style="color: white; font-size: 20px;">후원하기</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link ${current eq 'recruitList' ? 'active' : '' }" href="/recruit/recruitList" style="color: white; font-size: 20px;">봉사활동 지원 / 모집</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link ${current eq 'noticeList' ? 'active' : '' }" href="/notice/noticeList" style="color: white; font-size: 20px;">공지사항</a>
                </li>
                ...
                <sec:authorize access="hasAuthority('admin')">
                    <li class="nav-item">
                        <a class="nav-link ${current eq 'adminPage' ? 'active' : '' }" href="/member/adminPage" style="color: white; font-size: 20px;">운영자 페이지</a>
                    </li>
                </sec:authorize>

                <sec:authorize access="isAuthenticated()">
                    <li class="nav-item">
                        <a class="nav-link" href="/member/logout" style="color: white; font-size: 20px;">로그아웃</a>
                    </li>
                </sec:authorize>
            </ul>

    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="d-flex">
                <div class="me-auto">
                    <h1>
                        <span id="recruitIdText"> ${recruit.id } </span>
                        번게시물
                    </h1>
                </div>
            </div>
            ...
            <div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="${recruit.title }" readonly />
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" readonly rows="10">${recruit.body }</textarea>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">작성자</label>
                    <input type="text" class="form-control" value="${recruit.writer }" readonly />
                </div>
                <div class="mb-3">
...
<%--                </div>--%>
            ...
            <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=	bda72dd7c59b7d94fe8ae4094af53543"></script>
            <script>
                var mapContainer = document.getElementById('map'), // 지도를 표시할 div
                    mapOption = {
                        center: new kakao.maps.LatLng(37.555968, 126.971700), // 지도의 중심좌표
                        level: 3 // 지도의 확대 레벨
                    };
